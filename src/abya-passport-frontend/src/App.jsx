...
function App() {
            ...
            <div className="relative z-10 bg-transparent">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-40">
                ...
                <div className="text-left">
                  <h3 className="font-bold tracking-tight text-yellow-500 animate-fadein">
                    ABYA PASSPORT
                  </h3>
                  ...
                  <p className="text-xl text-gray-600 mb-8 animate-fadein delay-300">
                    Create, issue, manage and verify verifiable credentials with
                    ABYA Passport — a lightweight, developer-friendly platform
                    for the Web3 era.
                  </p>
                  <button
              ...
              <h2 className="text-3xl font-bold text-blue-900 dark-text-yellow mb-4 text-center">
                Key Features
              </h2>
              <p className="text-xl text-gray-600 mt-8 mb-8 animate-fadein delay-500">
                Explore the key features of ABYA Passport to enhance your
                identity management experience.
              </p>
              <div
                className={`grid md:grid-cols-3 gap-8 mt-16 transition-colors duration-300 rounded-2xl ${
                  darkMode ? "" : ""
                }`}
              >
                {/* Card 1 */}
                <div
                  className={`relative group bg-gradient-to-br from-blue-100 to-white border border-blue-200 ${
                    darkMode ? "border-yellow-400" : "border-blue-200"
                  } rounded-2xl p-7 shadow-lg hover:shadow-2xl transition-all duration-200 overflow-hidden feature-card animate-fadein delay-600`}
                >
                  ...
                  <h3 className="text-lg font-bold text-blue-900 dark-text-white mb-2 text-center">
                    Internet Identity
                  </h3>
                  <p className="text-blue-900 text-sm text-center dark-text-white mb-2">
                  ...
                  <div className="absolute -top-4 -right-4 opacity-10 group-hover:opacity-20 transition-opacity duration-200">
                    ...
                    >
                      <g
                        ...
                        stroke-width="1.5"
                      >
                        <path d="M3 14.25v9M16.478 2.144A8.3 8.3 0 0 0 11.888.75C7.37.75 3.613 4.453 3.072 9.2M21 23.25V10.375A10.2 10.2 0 0 0 20.023 6" />
                        <path d="M18 15.75v-4.5c0-3.713-2.7-6.75-6-6.75s-6 3.037-6 6.75v12m12 0v-4.5m-9-1.5v6" />
                        <path d="M15 23.25V12c0-2.063-1.35-3.75-3-3.75S9 9.937 9 12v2.25m3 6v3m0-12v6" />
                      </g>
                    </svg>
                  </div>
                  <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-blue-100 mb-5 mx-auto shadow-inner">
              ...
              <div className="mt-14 flex flex-wrap justify-center gap-6 animate-fadein delay-900">
                ...
                <div className="mt-24 animate-fadein delay-1000 flex flex-col items-center justify-center">
                  ...
                  <p className="text-lg text-gray-600 mb-6 text-center max-w-xl">
                    Connect with builders, developers, and digital identity
                    enthusiasts. Share feedback, get support, and help shape the
                    future of ABYA Passport!
                  </p>
                  <div className="flex flex-wrap justify-center gap-6 mb-4">
                    <a
                      href="https://discord.gg/t7fUu62h58"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-6 py-3 bg-blue-900 text-gray-100 rounded-2xl font-bold text-lg shadow-md hover:shadow-xl hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-yellow-400"
  ...
  return (
    <>
      ...
      >
        {!darkMode ? (
          <MoonIcon className="w-5 h-5 text-gray-800 dark:text-yellow-400" />
        ) : (
          <SunMediumIcon className="w-5 h-5 text-yellow-400" />
        )}
      ...
      <footer className="mt-24 py-8 border-t border-gray-100 dark:border-blue-900 bg-white/90 dark:bg-transparent text-center text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300 backdrop-blur-xl relative z-20">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 px-4">
          <div>
            &copy; {new Date().getFullYear()} ABYA Passport. All rights
            reserved.
          </div>
          <div className="flex items-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-blue-700 dark:hover:text-yellow-400 transition-colors"
            >
              GitHub
            </a>
            <a
