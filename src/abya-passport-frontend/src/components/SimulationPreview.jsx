...
function SimulationPreview({ onNotify }) {
  ...
  return (
    <div className="w-full max-w-md h-96 bg-white/90 border border-gray-100 rounded-3xl p-5 shadow-2xl flex flex-col justify-between">
      <div className="flex items-center justify-between mb-3">
        <div>
          <div className="text-xs text-slate-400">Flow simulation</div>
        </div>
      ...
      <div className="h-36 rounded-lg bg-gradient-to-br from-slate-50 to-white border border-gray-100 p-3 flex flex-col justify-between">
        <div>
          ...
          <div className="mt-2 text-sm font-medium text-yellow-600">{currentStep ? currentStep.label : 'Preparing'}</div>
          {currentStep && (
      ...
      <div className="mt-4 flex items-center justify-between gap-3">
        <div className="mt-4 text-xs text-slate-500">This is a simulated demo — values are mock data for presentation only.</div>
